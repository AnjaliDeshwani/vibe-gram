...
export const SearchBar = () => {
  ...
  return (
    <div className="mt-2 lg:mt-5 relative">
      <div className="flex items-center gap-4 w-52 md:w-full bg-slate-200 py-2 px-4 lg:py-3 rounded-full focus-within:ring-1 focus-within:ring-sky-400 focus-within:bg-neutral-50">
      ...
      {searchText && (
        <div className="bg-neutral-50 w-52 md:w-full mt-[0.5px] border-2 rounded-md p-2 flex flex-col gap-4 shadow-lg absolute">
